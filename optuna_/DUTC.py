...
# Initialize model, loss, and optimizer
# Initialize model, loss, and optimizer
model = DWT_MLP_Model(input_channels=321+4, seq_length = 96, mlp_hidden_size=64, output_channels=321+4, decompose_layers= 3, dropout=0.28424578570453063, dilation = 2, mode = 'symmetric', wave = 'haar', kernel_size = 3)

criterion = nn.MSELoss()
optimizer = torch.optim.Adam(model.parameters(), lr=0.001044426450046505, weight_decay= 1.9224570619632926e-05)
...
#=======
num_epochs = 100
#>>>>>>> 237770f6ddc92caa47ce44c46b2af472f0c4663c
for epoch in range(num_epochs):
    ...
    for seq_x, seq_y, seq_x_mark, seq_y_mark in train_loader:
        ...
        loss = criterion(outputs, targets[:, :, :-4])  # Adjust indexing based on your data structure
        loss.backward()
        optimizer.step()
