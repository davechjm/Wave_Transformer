                    ...
                    for general_skip_type in general_skip_types:
                        for revin_type in revin_types:
                            ...
                            model = DWT_MLP_Model(input_channels=321+4, seq_length=seq_, pred_length = pred_,mlp_hidden_size=128, 
                                                ...
                                                num_encoder_layers=3, nhead=8, 
                                                dropout_=dropout_enabled,
                                                skip_=skip_enabled, general_skip_=general_skip_type, Revin_=revin_type)
                            ...
                            best_model_path = f"best_model_{data_load_type}_{TCN_type}_{attention_type}_{dropout_enabled}_{skip_enabled}_{general_skip_type}_{revin_type}.pt"
                            ...
                            #print(f'Test Loss for configuration: TCN_type={TCN_type}, attention_type={attention_type}, dropout_enabled={dropout_enabled}, skip_enabled={skip_enabled}, general_skip={general_skip_type}, Revin={revin_type}: {test_loss:.4f}')
